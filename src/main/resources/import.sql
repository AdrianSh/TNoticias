...
insert into User (id, avatar, email, password, lname, login, name, profile_background, roles, pregunta_de_seguridad, respuesta_de_seguridad, enabled) values (1, 'http://lorempixel.com/100/100/people/10/','a@1.com', '$2a$10$EP.pbGMSB04b9XFysC3T1ubWQ3TIGAWSzuenM0ef2M8yW928Zvs5S','S.','AdrianSh', 'Adrian', 'http://lorempixel.com/100/100/people/10/','user,admin', 'pregunta', 'respuesta', true);
insert into User (id, avatar, email, password, lname, login, name, profile_background, roles, pregunta_de_seguridad, respuesta_de_seguridad, enabled) values (2, 'http://lorempixel.com/100/100/people/10/','a@a.com', '$2a$10$adwDmBTvdVFtnublHT/xw.NTby67ikxkl3kPhaSj3ZMSmS2tA3bcO','Sanchez','AdrianSh', 'Nombre', 'http://lorempixel.com/100/100/people/10/','admin', 'pregunta', 'respuesta', true);
insert into User (id, avatar, email, password, lname, login, name, profile_background, roles, pregunta_de_seguridad, respuesta_de_seguridad, enabled) values (3, 'http://lorempixel.com/100/100/people/10/','alo@a.com', '$2a$10$tS2Bk1FevKOmDD49poA/oOq0QGaZ.XCZbgRfhVkqIDN0dmLAwVz1y','lolo','lolo', 'Sr', 'http://lorempixel.com/100/100/people/10/','admin', 'pregunta', 'respuesta', true);
